...
#' @param box Logic value, whether to close the graph.
#' @param point_plot Logic value,whether to add points in the diagram.
#' @return data_new2
#' @export kmeans_plot3
#'
#' @examples
...
kmeans_plot3 <- function(data,centers,row,col,
                         center_col = 'black',
                         las = 2,box = TRUE,
                         point_plot = FALSE){
